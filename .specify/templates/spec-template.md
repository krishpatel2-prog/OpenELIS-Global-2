...
*Derived from `.specify/memory/constitution.md` - include only relevant principles for this feature:*
...
- **CR-005**: External data integration MUST use FHIR R4 + IHE profiles (if applicable)
